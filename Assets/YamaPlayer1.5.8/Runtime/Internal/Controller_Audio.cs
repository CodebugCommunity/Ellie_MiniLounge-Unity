...
namespace Yamadev.YamaStream
{
    public partial class Controller
    {
        ...
        //EDIT BY GUNPOWEDER77 FOR SOUNDSYSTEM
        [SerializeField] UdonSharpBehaviour SoundSystemController;
        //END EDIT
        ...
        public void UpdateAudio()
        {
            foreach (AudioSource audioSource in _audioSources)
            {
                ...
                //EDIT BY GUNPOWEDER77 FOR SOUNDSYSTEM
                if (SoundSystemController != null) audioSource.mute = !(bool)SoundSystemController.GetProgramVariable("localPlayerInCollider") || _mute; //(bool)SoundSystemController.GetProgramVariable("localPlayerInCollider") ? _mute : true;
                else audioSource.mute = _mute;
                //END EDIT
