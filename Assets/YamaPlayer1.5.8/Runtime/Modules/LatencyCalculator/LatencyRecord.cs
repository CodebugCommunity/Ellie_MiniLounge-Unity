...
namespace Yamadev.YamaStream
{
    ...
    public class LatencyRecord : UdonSharpBehaviour
    {
        ...
        void Start()
        {
            //EDIT BY GUNPOWDER 77 TO MAKE IT WORK
            if (_manager = null) _manager = (LatencyManager)GetComponentInParent(typeof(UdonSharpBehaviour)); //Genuinely how did anything work without this
            //END EDIT
